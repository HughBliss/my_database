...
var exampleImplementors = []string{"Example", "Node"}
...
func (c *Client) noder(ctx context.Context, table string, id xid.ID) (Noder, error) {
	...
	case example.Table:
		...
		if fc := graphql.GetFieldContext(ctx); fc != nil {
			if err := query.collectField(ctx, true, graphql.GetOperationContext(ctx), fc.Field, nil, exampleImplementors...); err != nil {
				return nil, err
			}
		}
...
func (c *Client) noders(ctx context.Context, table string, ids []xid.ID) ([]Noder, error) {
	...
	case example.Table:
		...
		query, err := query.CollectFields(ctx, exampleImplementors...)
		if err != nil {
			return nil, err
		}
