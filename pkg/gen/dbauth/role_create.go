...
func (rc *RoleCreate) SetDomainID(x xid.ID) *RoleCreate {
	rc.mutation.SetDomainID(x)
	return rc
}
...
func (rc *RoleCreate) SetDomain(d *Domain) *RoleCreate {
	return rc.SetDomainID(d.ID)
}
...
func (rc *RoleCreate) check() error {
	if _, ok := rc.mutation.CreateTime(); !ok {
		return &ValidationError{Name: "create_time", err: errors.New(`dbauth: missing required field "Role.create_time"`)}
	}
	if _, ok := rc.mutation.UpdateTime(); !ok {
		return &ValidationError{Name: "update_time", err: errors.New(`dbauth: missing required field "Role.update_time"`)}
	}
	if _, ok := rc.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`dbauth: missing required field "Role.name"`)}
	}
	if _, ok := rc.mutation.Description(); !ok {
		return &ValidationError{Name: "description", err: errors.New(`dbauth: missing required field "Role.description"`)}
	}
	if _, ok := rc.mutation.Permissions(); !ok {
		return &ValidationError{Name: "permissions", err: errors.New(`dbauth: missing required field "Role.permissions"`)}
	}
	if _, ok := rc.mutation.DomainID(); !ok {
		return &ValidationError{Name: "domain_id", err: errors.New(`dbauth: missing required field "Role.domain_id"`)}
	}
	if len(rc.mutation.DomainIDs()) == 0 {
		return &ValidationError{Name: "domain", err: errors.New(`dbauth: missing required edge "Role.domain"`)}
	}
	return nil
}
...
// SetDomainID sets the "domain_id" field.
func (u *RoleUpsert) SetDomainID(v xid.ID) *RoleUpsert {
...
// SetDomainID sets the "domain_id" field.
func (u *RoleUpsertOne) SetDomainID(v xid.ID) *RoleUpsertOne {
	return u.Update(func(s *RoleUpsert) {
		s.SetDomainID(v)
	})
}
...
func (u *RoleUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("dbauth: missing options for RoleCreate.OnConflict")
	}
...
func (u *RoleUpsertOne) ID(ctx context.Context) (id xid.ID, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		...
		return id, errors.New("dbauth: RoleUpsertOne.ID is not supported by MySQL driver. Use RoleUpsertOne.Exec instead")
	}
...
// SetDomainID sets the "domain_id" field.
func (u *RoleUpsertBulk) SetDomainID(v xid.ID) *RoleUpsertBulk {
	return u.Update(func(s *RoleUpsert) {
		s.SetDomainID(v)
	})
}
...
func (u *RoleUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("dbauth: OnConflict was set for builder %d. Set it on the RoleCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("dbauth: missing options for RoleCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
