...
var ErrTxStarted = errors.New("dbexample: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("dbexample: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("dbexample: unknown mutation type %T", m)
	}
}
...
func (c *ExampleClient) UpdateOneID(id xid.ID) *ExampleUpdateOne {
...
func (c *ExampleClient) DeleteOneID(id xid.ID) *ExampleDeleteOne {
...
func (c *ExampleClient) Get(ctx context.Context, id xid.ID) (*Example, error) {
	return c.Query().Where(example.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *ExampleClient) GetX(ctx context.Context, id xid.ID) *Example {
...
func (c *ExampleClient) mutate(ctx context.Context, m *ExampleMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("dbexample: unknown Example mutation op: %q", m.Op())
	}
}
